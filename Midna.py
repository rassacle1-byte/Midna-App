...
def main(page: ft.Page):
    # --- CONFIGURACIÓN JARVIS ULTRA-ESTABLE ---
    ...
    NEON_CYAN = "#00FFFF"
    DARK_BLUE_TRANSPARENT = "#001F3FEE"

    # GENERAMOS EL ID DIRECTAMENTE (Sin usar page.session para evitar errores)
